  ...
  return (
    <div id="contact" class="pt-5 md:pt-16 pb-16">
      ...
      <div class="flex justify-center">
        <a href="https://medium.com/@szmizorsz" target="_blank" rel="noopener noreferrer" class="mr-10" >
          <img src={medium} alt="medium" width="40"></img>
        </a>
        <a href="https://github.com/szmizorsz" target="_blank" rel="noopener noreferrer" class="mr-10">
          <img src={github} alt="github" width="40"></img>
        </a>
        <a href="https://www.linkedin.com/in/szabolcs-szentes-21859b68/" target="_blank" rel="noopener noreferrer" class="mr-10">
          <img src={linkedin} alt="linkedin" width="40"></img>
        </a>
        <a href="https://twitter.com/SzentesSzabolcs" target="_blank" rel="noopener noreferrer" >
          <img src={twitter} alt="twitter" width="40"></img>
        </a>
      </div>
